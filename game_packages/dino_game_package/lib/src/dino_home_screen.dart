...
class DinoHomeScreen extends StatefulWidget {
  const DinoHomeScreen({Key? key}) : super(key: key);
  @override
  _DinoHomeScreenState createState() => _DinoHomeScreenState();
}

class _DinoHomeScreenState extends State<DinoHomeScreen>
