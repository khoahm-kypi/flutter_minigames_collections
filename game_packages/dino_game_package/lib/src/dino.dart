...
List<Sprite> dino = [
  Sprite()
    ..imagePath = "packages/dino_game_package/assets/images/dino/dino_1.png"
    ..imageWidth = 88
    ..imageHeight = 94,
  Sprite()
    ..imagePath = "packages/dino_game_package/assets/images/dino/dino_2.png"
    ..imageWidth = 88
    ..imageHeight = 94,
  Sprite()
    ..imagePath = "packages/dino_game_package/assets/images/dino/dino_3.png"
    ..imageWidth = 88
    ..imageHeight = 94,
  Sprite()
    ..imagePath = "packages/dino_game_package/assets/images/dino/dino_4.png"
    ..imageWidth = 88
    ..imageHeight = 94,
  Sprite()
    ..imagePath = "packages/dino_game_package/assets/images/dino/dino_5.png"
    ..imageWidth = 88
    ..imageHeight = 94,
  Sprite()
    ..imagePath = "packages/dino_game_package/assets/images/dino/dino_6.png"
    ..imageWidth = 88
    ..imageHeight = 94,
];
